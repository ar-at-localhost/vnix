...
function M.get_defaults()
  return {
    ...
    toggle_tt = {
      key = "'",
      mods = "LEADER",
      action = act.EmitEvent("vnix:tt"),
      description = "Toggle Time Tracker",
    },
    show_tt = {
      key = "m",
      mods = "LEADER|SHIFT",
      action = act.EmitEvent("vnix:show-tt"),
      description = "Show Time Tracker",
    },
    inspect = {
      key = "i",
      mods = "LEADER",
    ...
    create_rename = {
      key = "c",
      mods = "LEADER",
      action = act.EmitEvent("vnix:rename"),
